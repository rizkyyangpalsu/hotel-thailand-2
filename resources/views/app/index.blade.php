...
@section('content')
    <section class="inner-page-banner">
        <video src="{{url('assets/video/banner.mp4')}}" class="video" style="height: 450px;float: right;" muted loop
               autoplay></video>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title text-center">
                        ...
                        <p>Relaxed and effortlessly luxurious, Rosedon’s bedrooms are individually decorated so no two
                            are
